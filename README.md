# 𝗦𝗢𝗟𝗨𝗧𝗜𝗢𝗡 𝗔𝗚𝗥𝗢 𝗦𝗘𝗥𝗩𝗜𝗖𝗘𝗦 - Plateforme Web E-commerce

Bienvenue sur le dépôt du code source de l'application web **𝗦𝗢𝗟𝗨𝗧𝗜𝗢𝗡 𝗔𝗚𝗥𝗢 𝗦𝗘𝗥𝗩𝗜𝗖𝗘𝗦**. Ce projet est une solution complète (Site Vitrine + E-commerce + Administration) développée avec des technologies modernes pour assurer performance et évolutivité.
...
| :--- | :--- | :--- | :--- |
| **Administrateur** | `admin@.cm` | `admin123` | **OTP : 2025** |
| **Utilisateur** | `user@.cm` | `user123` | |
