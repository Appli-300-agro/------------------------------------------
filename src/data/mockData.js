// Catalogue de 100 produits pour 𝗦𝗢𝗟𝗨𝗧𝗜𝗢𝗡 𝗔𝗚𝗥𝗢 𝗦𝗘𝗥𝗩𝗜𝗖𝗘𝗦
...
const generateProducts = () => {
  ...
  for (let i = 1; i <= 100; i++) {
    ...
    products.push({
      id: `prod-${i}`,
      name: productName,
      description: `Découvrez notre ${dishBaseName}, une solution de la catégorie ${sector} proposée par 𝗦𝗢𝗟𝗨𝗧𝗜𝗢𝗡 𝗔𝗚𝗥𝗢 𝗦𝗘𝗥𝗩𝗜𝗖𝗘𝗦. Qualité garantie.`,
